...
## Usage
To run the script, simply execute the `tide_chart.py` file and enter the zip code for the location for which you want to retrieve the tide data.
